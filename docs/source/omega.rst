...
transforming the *full* nuclear-motion Hamiltonian, which introduces spin–orbit-induced non-adiabatic couplings (NACs); see, e.g., :cite:p:`10TaKlKr.KC`, :cite:p:`24BrDrYu`, :cite:p:`25Brady`.
